...
First, lets make a list of the top countires, using the land_use data.
```{r}
land_use %>%
  glimpse()
...
```
 ...
 Now, lets use that list to analyze key crop yields.
```{r}
...
Now lets use some statistical modeling to measure the distances between countries, using TidyModels!
